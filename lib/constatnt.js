export const PRODUCTS = [
  ...
  },
  {
    ...
    features:
      "Featuring a genuine leather head strap and premium earcups, these headphones deliver superior comfort for those who like to enjoy endless listening. It includes intuitive controls designed for any situation. Whether you're taking a business call or just in your own personal space, the auto on/off and pause features ensure that you’ll never miss a beat.\n\nThe advanced Active Noise Cancellation (ANC) features allow you to immerse yourself in music without distractions by balancing external noise to keep you fully focused on the content. Customisable earcup controls, a remarkable 40-hour battery life and industry-leading Bluetooth connectivity provide greater versatility with the reliable wireless range of up to 50 feet.",
    includes: [
      { quantity: 1, item: "Headphone unit" },
      { quantity: 2, item: "Replacement earcups" },
      { quantity: 1, item: "User manual" },
